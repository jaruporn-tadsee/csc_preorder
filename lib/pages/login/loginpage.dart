import 'package:csc_preorder_beta/pages/login/fpasspage.dart';
import 'package:csc_preorder_beta/pages/homepage/homepage.dart';
import 'package:csc_preorder_beta/pages/login/registerpage.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: buildButtomBar(context),
    );
  }
  ...
  Container buildButtomBar(BuildContext context) {
    return Container(
